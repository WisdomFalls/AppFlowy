...
export const PLACES = [
  ...
  { id: 'cereal', name: 'Planet Cereal', planet: 'cereal', danger: 3, training: 1.4, tags: ['ruins', 'dragonballs'], desc: 'Ruins, dust, and a dragon nobody outside the system has heard of.' },
